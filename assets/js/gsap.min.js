...
!(function(t, e) {
                        ...
                        if (
                            ...
                            if (
                                (s < c && (T = !T),
                                    ...
                                    (this._tTime = v), !e && this.parent && At(this, "onRepeat"),
                    ...
                    if (
                        (this._hasPause &&
                            ...
                            ((this._onUpdate = this.vars.onUpdate),
                                (this._initted = 1),
                                (this._zTime = t),
                                (_ = 0)), !_ && i && !e && !s && (At(this, "onStart"), this._tTime !== v))
                    )
                        return this;
                    if (_ <= i && 0 <= t)
                        for (n = this._first; n;) {
        ...
        if (
            ...
            (u = new pt[t]()).init(
                ...
                (function _processVars(t, e, i, n, a) {
                    if (
                        (s(t) && (t = Kt(t, a, e, i, n)), !v(t) || (t.style && t.nodeType) || $(t) || Z(t))
                    )
    ...
    var Nt,
        ...
        Gt = function _initTween(t, e, r) {
            ...
            if (
                ...
                for (
                    t._pt = t._ptCache = 0, T = (C && w(T)) || (T && !C), n = 0; n < E.length; n++
                ) {
                    if (
        ...
        function Tween(e, r, i, n) {
            ...
            if (
                ((a._targets = A.length ?
                        ea(A) :
                        R(
                            "GSAP target " + e + " not found. https://greensock.com", !q.nullTargetWarn
                        ) || []),
                    (a._ptLookup = []),
                    (a._overwrite = b),
                    x || T || y(_) || y(m))
                ...
                if (
                    ...
                    for (o = 0; o < h; o++)
                        ...
                        (u.delay =
                            (+Kt(m, _assertThisInitialized(a), o, f, A) || 0) - a._delay), !T &&
                        1 === h &&
                        u.delay &&
                ...
                if (p) {
                    if (
                        ...
                        if (((i = m), (l = this.timeline), this._repeat)) {
                            ...
                            a !== o &&
                                (l && this._yEase && Qb(l, u), !this.vars.repeatRefresh ||
                                    u ||
                                    this._lock ||
                                    ((this._lock = r = 1),
                        ...
                        this._onUpdate &&
                            ...
                            (_ && !this._onUpdate && Ca(this, t, 0, !0),
                                ...
                                (_ && !c) ||
                                !(m || c || u) ||
                                (At(this, m === d ? "onComplete" : "onReverseComplete", !0), !this._prom ||
    ...
    function Vd(e) {
        ...
        return (
            (r && (r.width || r.height)) || e.getBBox === Td || (r = Td.call(e, !0)), !r || r.width || r.x || r.y ?
            r :
            {
                x: +Ud(e, ["x", "cx", "x1"]) || 0,
                y: +Ud(e, ["y", "cy", "y1"]) || 0,
    ...
    var De,
        ...
        mr = function _checkPropPrefix(t, e, r) {
            ...
            for (
                t = t.charAt(0).toUpperCase() + t.substr(1); n-- && !(_r[n] + t in i);
